...
class DreamBoothDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.class_data_root:
            #class_images_dir = self.class_images_path
            #class_image_files = [file for file in os.listdir(class_images_dir) if not file.startswith('.')]
            #class_image_path = os.path.join(class_images_dir, class_image_files[index % self.num_class_images])
